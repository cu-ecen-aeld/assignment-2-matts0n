...
void test_validate_my_username()
{
    ...
    const char* name1;
     ...
     name1 = my_username();
     name2 = malloc_username_from_conf_file();
     TEST_ASSERT_EQUAL_STRING_MESSAGE(name1,name2,"failure");
     
     /*TEST_ASSERT_EQUAL_STRING_MESSAGE(my_username(),malloc_username_from_conf_file(),"failure");*/ 
}
